	...
	ezcrypt = function( type, func ) {
		...
		libs = {
			ENCRYPT_TYPE: {
				'CLIPPERZ': {
					'lib': [
					    'crypto/clipperz/MochiKit/MochiKit.js',
						'crypto/clipperz/MochiKit/Base.js',
					    'crypto/clipperz/MochiKit/Logging.js',
					    'crypto/clipperz/JSON/json2.js',
					    'crypto/clipperz/YUI/Utils.js',
						'crypto/clipperz/Base.js',
						'crypto/clipperz/ByteArray.js',
						'crypto/clipperz/Crypto/SHA.js',
						'crypto/clipperz/Crypto/AES.js'
					],
					'load': '',
					'decrypt': {
				...
				'CRYPTO_JS': {
					'lib': [
					    'crypto/crypto-js/crypto/crypto.js',
					    'crypto/crypto-js/sha1/sha1.js',
					    'crypto/crypto-js/hmac/hmac.js',
					    'crypto/crypto-js/pbkdf2/pbkdf2.js',
					    'crypto/crypto-js/blockmodes/blockmodes.js',
					    'crypto/crypto-js/aes/aes.js'
					],
					'load': '',
					'decrypt': {
				...
				'PIDCRYPT': {
					'lib': [
						'crypto/pidCrypt/pidcrypt_util.js',
						'crypto/pidCrypt/pidcrypt.js',
						'crypto/pidCrypt/md5.js',
						'crypto/pidCrypt/aes_core.js',
						'crypto/pidCrypt/aes_cbc.js'
					],
