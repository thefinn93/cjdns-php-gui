...
<div class="row">
    ...
    <div class="span2">
        <div class="btn-group">
            ...
            <a href="#" onclick="getPeers()" rel="tooltip" title="Refresh the list of UDP peers" class="btn"><i class="icon-refresh"></i></a>
        </div>
    </div>
</div>
...
<br /><br />
<div class="row">
    <div class="span10"><h1>ETH Peers</h1></div>
    <div class="span2">
        <div class="btn-group">
            <a href="#" onclick="addPeer()" rel="tooltip" title="Add a ETH peer" class="btn btn-success"><i class="icon-plus"></i></a>
            <a href="#" onclick="getPeers()" rel="tooltip" title="Refresh the list of ETH peers" class="btn"><i class="icon-refresh"></i></a>
        </div>
    </div>
</div>
...
<table class="table table-condensed">
<thead>
<tr><td>Name</td><td>mac</td><td>Public Key</td><td>Password</td><td>CJDNS IP</td><td>Actions</td></tr>
</thead>
<tbody id="ETHPeer_List">
</tbody>
</table>
...
<div class="modal fade hide" id="addpeermodal">
    ...
    <div class="modal-body">
        <div id="addPeerTypeWrapper">
            <label class="radio inline">
                <input type="radio" name="addPeerType" id="addPeerType-UDP" value="UDP" onchange="swtichUDPETH()" checked> UDP
            </label>
            <label class="radio inline">
                <input type="radio" name="addPeerType" id="addPeerType-ETH" value="ETH" onchange="swtichUDPETH()"> ETH
            </label>
        </div>
